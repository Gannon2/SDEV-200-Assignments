...
public class Main {
  ...
  public static void main(String[] args) {
    ...
    for (double feet = 1.0, meters = 20.0; feet <= 10.0; feet++, meters += 5) {
      ...
      // meter = 0.305 * foot
      // foot = 3.279 * meter
      // QUESTION: I was only able to figure out printf because Replit will try to auto corrent code sometimes, how come printIn doesn't work with lines 21, 22, 26, qne 27? I was having trouble figuring that out for 2 hours.
